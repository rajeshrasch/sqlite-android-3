...
package io.expo.android.database.benchmark;
...
public class Benchmark {
    ...
    private void testRequerySQLiteWrite(Statistics statistics) {
        ...
        io.expo.android.database.sqlite.SQLiteDatabase db = requerySQLite.getWritableDatabase();
        io.expo.android.database.sqlite.SQLiteStatement statement = db.compileStatement(
            String.format("insert into %s (%s, %s) values (?,?)",
                Record.TABLE_NAME,
                Record.COLUMN_CONTENT,
                Record.COLUMN_CREATED_TIME));
    ...
    private void testRequerySQLiteRead(Statistics statistics) {
        ...
        Cursor cursor = null;
        try {
            io.expo.android.database.sqlite.SQLiteDatabase db =
    ...
    private static class RequerySQLite extends
        io.expo.android.database.sqlite.SQLiteOpenHelper {
        public RequerySQLite(Context context, String name) {
            super(context, name, null, 1);
        }

        @Override
        public void onCreate(io.expo.android.database.sqlite.SQLiteDatabase db) {
            db.execSQL(Record.CREATE_STATEMENT);
        }

        @Override
        public void onUpgrade(io.expo.android.database.sqlite.SQLiteDatabase db,
