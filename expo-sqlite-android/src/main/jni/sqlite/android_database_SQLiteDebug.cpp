...
{
    { "nativeGetPagerStats", "(Lio/expo/android/database/sqlite/SQLiteDebug$PagerStats;)V",
...
{
    jclass clazz;
    FIND_CLASS(clazz, "io/expo/android/database/sqlite/SQLiteDebug$PagerStats");
    ...
    return jniRegisterNativeMethods(env, "io/expo/android/database/sqlite/SQLiteDebug",
